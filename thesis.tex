...
\defbibentryset{micromegas}{micromegas1,micromegas2}
\defbibentryset{dirac}{dirac1,dirac2}
\defbibentryset{gsw}{PhysRevLett.19.1264,nobelstiftelsen1968elementary,PhysRevD.2.1285}
...
\begin{document}
    ...
    \begin{declaration}
        ...
        \ChapterRef{chap:exploring_at}, the author's main contributions were in
    ...
    \setcounter{page}{4} \tableofcontents \listoffigures
